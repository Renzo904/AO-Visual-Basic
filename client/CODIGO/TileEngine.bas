...
If .priv > 0 And .priv < 5 Then
                            If .RenderColor < 10 Then
                            .RenderColor = .RenderColor + 1
                            color = .ColorActual
                            If .RenderColor >= 10 Then
                            .RenderColor = 0
                            .ColorActual = RGB(RandomNumber(10, 255), RandomNumber(20, 255), RandomNumber(20, 255))
                            color = .ColorActual
                            End If
                            End If
                            End If
                            ...
                            Call RenderTextCentered(PixelOffsetX + TilePixelWidth \ 2 + 5 - .RenderColor / 2, PixelOffsetY + 30, line, color, frmMain.font)
                            
                            'Clan
                            line = mid$(.Nombre, Pos)
                            Call RenderTextCentered(PixelOffsetX + TilePixelWidth \ 2 + 5 - .RenderColor / 2, PixelOffsetY + 45, line, color, frmMain.font)
                                Dim Ren As Boolean
                            Dim siPos As Integer
                            If .priv = 1 Then
                            line = "<Consejero>"
                            Ren = True
                            ElseIf .priv = 2 Then
                            ...
                            siPos = 45
                            End If
                            RenderTextCentered PixelOffsetX + TilePixelWidth / 2 + 5, PixelOffsetY + siPos, line, color, frmMain.font
                            End If
                        End If
                    End If
                End If
